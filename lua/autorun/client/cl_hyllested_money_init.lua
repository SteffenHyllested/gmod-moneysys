...
hook.Add("HUDPaint", "draw-money-hud", function()
    ...
    draw.SimpleTextOutlined(string.format("$%.2f",client:GetNWInt("Money")), "HyllstedMoney:MainFont", Width/2, 100, Color( 100, 255, 100, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_TOP, 2, Color(0,0,0,255))
end)